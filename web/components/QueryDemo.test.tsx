...
function streamingResponse(): Response {
  ...
  const chunks = [
    ...
    "event: answer_delta\ndata: {\"delta\":\"Docker image builds [1].\"}\n\nevent: citations\ndata: {\"citations\":[{\"citation_id\":\"1\",\"document_id\":\"doc-1\",\"chunk_id\":\"chunk-1\"}],\"sources\":[{\"citation_id\":\"1\",\"document_id\":\"doc-1\",\"chunk_id\":\"chunk-1\",\"title\":\"BuildKit\",\"source\":\"docker\",\"url\":\"https://docs.docker.com/build/buildkit/\"}]}\n\n",
...
describe("QueryDemo", () => {
  ...
  it("updates the answer from stream deltas and renders citations", async () => {
    ...
    expect(
      await screen.findByText("BuildKit improves Docker image builds [1]."),
    ).toBeInTheDocument();
    expect(
